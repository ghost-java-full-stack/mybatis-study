...
class DynSqlTest {
    ...
    static void setUp() throws Exception {
        try (Reader configReader = Resources
            .getResourceAsReader("org/apache/ibatis/submitted/dynsql/MapperConfig.xml")) {
    ...
    void testSelect() {
        try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
            ...
            List<Map<String, Object>> answer = sqlSession.selectList("org.apache.ibatis.submitted.dynsql.select",
                    parameter);
    ...
    void testSelectLike() {
        try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
            ...
            List<Map<String, Object>> answer = sqlSession.selectList("org.apache.ibatis.submitted.dynsql.selectLike",
                    "Ba");
    ...
    /**
     * Verify that can specify any variable name for parameter object when parameter is
     * value object that a type handler exists.
     *
    ...
    void testCustomValueObjectWithoutParamAnnotation() throws IOException {
        ...
        try (Reader configReader = Resources
            ...
            sqlSessionFactory.getConfiguration()
                ...
                .register(DynSqlMapper.Conditions.class, new TypeHandler<DynSqlMapper.Conditions>() {
                    @Override
                    public void setParameter(PreparedStatement ps, int i, DynSqlMapper.Conditions parameter,
                    ...
                    @Override
                    public DynSqlMapper.Conditions getResult(CallableStatement cs, int columnIndex)
                            throws SQLException {
                        return null;
                    }
                });
