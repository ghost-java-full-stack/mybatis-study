...
class OgnlStaticTest {
    ...
    static void setUp() throws Exception {
        ...
        try (Reader reader = Resources
            .getResourceAsReader("org/apache/ibatis/submitted/ognlstatic/mybatis-config.xml")) {
     ...
     * <p>
     * There are two parameter mappings but DefaulParameterHandler maps them both to input
     * paremeter (integer)
     */
    @Test // see issue #448
