...
class SelectKeyTest {
    ...
    void testSeleckKeyReturnsNoData() {
        try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
            ...
            Assertions.assertThrows(PersistenceException.class, () -> sqlSession
                .insert("org.apache.ibatis.submitted.selectkey.Table2.insertNoValuesInSelectKey", parms));
        }
    }
    ...
    void testSeleckKeyWithWrongKeyProperty() {
        try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
            ...
            name.setName("Kyoto");
            Assertions.assertThrows(PersistenceException.class, () -> sqlSession
                .insert("org.apache.ibatis.submitted.selectkey.Table2.insertWrongKeyProperty", name));
        }
    }
