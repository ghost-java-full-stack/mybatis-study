...
class HeavyInitialLoadTest {
     ...
     *
     * Use the thing mapper for the first time in multiple threads. The mapper contains a
     * lot of ognl references to static final class members like:
     *
     ...
     * translated to a 'null' value, which is used to invoke the 'equals' method on (hence
     * the 'target is null for method equals' exception).
     */
    @Test
