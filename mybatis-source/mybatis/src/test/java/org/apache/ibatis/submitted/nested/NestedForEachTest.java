...
class NestedForEachTest {
    ...
    void testSimpleSelect() {
        try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
            ...
            List<Map<String, Object>> answer = sqlSession
                .selectList("org.apache.ibatis.submitted.nested.Mapper.simpleSelect", parameter);
    ...
    void testNestedSelect() {
        try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
            ...
            List<Map<String, Object>> answer = sqlSession
                .selectList("org.apache.ibatis.submitted.nested.Mapper.nestedSelect", parameter);
