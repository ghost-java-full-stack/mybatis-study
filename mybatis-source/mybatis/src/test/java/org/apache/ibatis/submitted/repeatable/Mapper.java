...
public interface Mapper {
    ...
    @SelectKey(statement = "SELECT COUNT(*) + 1 FROM users", keyProperty = "id", before = true,
            resultType = Integer.class, databaseId = "hsql")
    @SelectKey(statement = "SELECT COUNT(*) + 1001 FROM users", keyProperty = "id", before = true,
            resultType = Integer.class, databaseId = "derby")
    @SelectKey(statement = "SELECT COUNT(*) + 10001 FROM users", keyProperty = "id", before = true,
