...
public class TypeParameterResolver {
     ...
     * @param srcType the src type
     * @return The return type of the method as {@link Type}. If it has type parameters in
     * the declaration,<br>
     * they will be resolved to the actual runtime {@link Type}s.
     */
     ...
     * @param method the method
     * @param srcType the src type
     * @return The parameter types of the method as an array of {@link Type}s. If they
     * have type parameters in the declaration,<br>
     * they will be resolved to the actual runtime {@link Type}s.
     */
