...
/**
 * This class represents a cached set of class definition information that allows for easy
 * mapping between property names and getter/setter methods.
 *
...
public class Reflector {
     ...
     * superclass. We use this method, instead of the simpler
     * <code>Class.getMethods()</code>, because we want to look for private methods as
     * well.
