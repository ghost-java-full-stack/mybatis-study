 ...
 * {@link CallableStatement#wasNull()} method for handling the SQL {@code NULL} value. In
 * other words, {@code null} value handling should be performed on subclass.
 * </p>
 *
...
public abstract class BaseTypeHandler<T> extends TypeReference<T> implements TypeHandler<T> {
     ...
     * @param rs the rs
     * @param columnName Colunm name, when configuration <code>useColumnLabel</code> is
     * <code>false</code>
