...
/**
 * Specify the behavior when detects an unknown column (or unknown property type) of
...
public enum AutoMappingUnknownColumnBehavior {
    ...
    /**
     * Perform the action when detects an unknown column (or unknown property type) of
     * automatic mapping target.
