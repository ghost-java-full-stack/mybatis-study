...
public class Configuration {
    ...
    /**
     * Configuration factory class. Used to create Configuration for loading deserialized
     * unread properties.
     *
     * @see <a href='https://github.com/mybatis/old-google-code-issues/issues/300'>Issue
     * 300 (google code)</a>
     */
    ...
    /*
     * A map holds cache-ref relationship. The key is the namespace that references a
     * cache bound to another namespace and the value is the namespace which the actual
     * cache is bound to.
     */
    ...
    /*
     * Parses all the unprocessed statement nodes in the cache. It is recommended to call
     * this method once all the mappers are added as it provides fail-fast statement
     * validation.
     */
